...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context) {
        ...
        inflater.inflate(R.layout.widgets_residemenu, this);
...
//    }
    ...
    private void initValue(Activity activity) {
        ...
        viewDecor = (ViewGroup) activity.getWindow().getDecorView();//root view
        Log.d("YI", "viewDecor:" + viewDecor.toString());
        viewActivity = new TouchDisableView(this.activity);

        View mContent = viewDecor.getChildAt(0);
        Log.d("YI", "mContent:" + mContent.toString());
        viewDecor.removeViewAt(0);
        viewActivity.setContent(mContent);
        addView(viewActivity);
        Log.d("YI", "viewActivity:" + viewActivity.toString());
        ViewGroup parent = (ViewGroup) scrollViewLeftMenu.getParent();
        Log.d("YI", "parent:" + parent.toString());
    ...
    public void setShadowVisible(boolean isVisible) {
        if (isVisible)
            imageViewShadow.setBackgroundResource(R.drawable.widgets_residemenu_shadow);
        else
    ...
    private AnimatorSet buildScaleDownAnimation(View target, float targetScaleX, float targetScaleY) {
        ...
        scaleDown.setInterpolator(new DecelerateInterpolator(activity, null));
